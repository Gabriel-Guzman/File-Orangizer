...
public class ThumbnailFileChooser extends JFileChooser {
	/* Written by someone on StackOverFlow */
    ...
    public ThumbnailFileChooser(DirectoryRestrictedFileSystemView dRFSW) {
        super(dRFSW);
    }
    ...
    private class ThumbnailView extends FileView {
        /** This thread pool is where the thumbnnail icon loaders run */
